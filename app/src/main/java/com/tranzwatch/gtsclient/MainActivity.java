...
public class MainActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.tranzwatch.gtsclient.R.xml.preferences);
        initPreferences();
    ...
    private void removeLauncherIcon() {
        ...
        if (packageManager.getComponentEnabledSetting(componentName) != PackageManager.COMPONENT_ENABLED_STATE_DISABLED) {
            ...
            builder.setMessage(getString(com.tranzwatch.gtsclient.R.string.hidden_alert));
    ...
    private void addShortcuts(String action, int name) {
        ...
        installShortCutIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE,
                Intent.ShortcutIconResource.fromContext(this, com.tranzwatch.gtsclient.R.mipmap.ic_launcher));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.tranzwatch.gtsclient.R.menu.main, menu);
        return super.onCreateOptionsMenu(menu);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == com.tranzwatch.gtsclient.R.id.status) {
            startActivity(new Intent(this, StatusActivity.class));
            return true;
        } else if (item.getItemId() == com.tranzwatch.gtsclient.R.id.shortcuts) {
            addShortcuts(ShortcutActivity.EXTRA_ACTION_START, com.tranzwatch.gtsclient.R.string.shortcut_start);
            addShortcuts(ShortcutActivity.EXTRA_ACTION_STOP, com.tranzwatch.gtsclient.R.string.shortcut_stop);
            addShortcuts(ShortcutActivity.EXTRA_ACTION_SOS, com.tranzwatch.gtsclient.R.string.shortcut_sos);
            return true;
        } else if (item.getItemId() == com.tranzwatch.gtsclient.R.id.about) {
    ...
    private void initPreferences() {
        PreferenceManager.setDefaultValues(this, com.tranzwatch.gtsclient.R.xml.preferences, false);
