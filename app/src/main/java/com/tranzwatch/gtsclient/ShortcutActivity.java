        ...
        if (location != null) {
            ...
            RequestManager.sendRequestAsync(request, new RequestManager.RequestHandler() {
                ...
                public void onComplete(boolean success) {
                    if (success) {
                        Toast.makeText(ShortcutActivity.this, com.tranzwatch.gtsclient.R.string.status_send_success, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(ShortcutActivity.this, com.tranzwatch.gtsclient.R.string.status_send_fail, Toast.LENGTH_SHORT).show();
                    }
                }
            });

        } else {
            Toast.makeText(this, com.tranzwatch.gtsclient.R.string.status_send_fail, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void checkShortcutAction(Intent intent) {
        ...
        switch (action) {
            case EXTRA_ACTION_START:
                ...
                Toast.makeText(this, com.tranzwatch.gtsclient.R.string.status_service_create, Toast.LENGTH_SHORT).show();
                break;
            case EXTRA_ACTION_STOP:
                PreferenceManager.getDefaultSharedPreferences(this)
                        .edit().putBoolean(MainActivity.KEY_STATUS, false).commit();
                stopService(new Intent(this, TrackingService.class));
                Toast.makeText(this, com.tranzwatch.gtsclient.R.string.status_service_destroy, Toast.LENGTH_SHORT).show();
                break;
