...
public class TrackingController implements PositionProvider.PositionListener, NetworkManager.NetworkHandler {
    ...
    public void onPositionUpdate(Position position) {
        StatusActivity.addMessage(context.getString(com.tranzwatch.gtsclient.R.string.status_location_update));
        if (position != null) {
            write(position);
        }
    }
    ...
    public void onNetworkUpdate(boolean isOnline) {
        StatusActivity.addMessage(context.getString(com.tranzwatch.gtsclient.R.string.status_connectivity_change));
        ...
        RequestManager.sendRequestAsync(request, new RequestManager.RequestHandler() {
            ...
            public void onComplete(boolean success) {
                if (success) {
                    ...
                    StatusActivity.addMessage(context.getString(com.tranzwatch.gtsclient.R.string.status_send_fail));
                    retry();
                }
                unlock();
            }
